...
/**************************************************************************/
/*!
    @brief  Instantiates sensor with Tasmota Serial
    @param  ts Pointer to TasmotaSerial object
    @param  password 32-bit integer password (default is 0)

*/
/**************************************************************************/
Adafruit_Fingerprint::Adafruit_Fingerprint(TasmotaSerial *ts,
                                           uint32_t password) {
  thePassword = password;
  theAddress = 0xFFFFFFFF;
